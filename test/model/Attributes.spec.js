...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesforceMarketingCloud.Attributes();
  });
  ...
  describe('Attributes', function() {
    it('should create an instance of Attributes', function() {
      ...
      //var instane = new SalesforceMarketingCloud.Attributes();
      //expect(instance).to.be.a(SalesforceMarketingCloud.Attributes);
    });
