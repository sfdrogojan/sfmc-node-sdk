...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesforceMarketingCloud.ApiError();
  });
  ...
  describe('ApiError', function() {
    it('should create an instance of ApiError', function() {
      ...
      //var instane = new SalesforceMarketingCloud.ApiError();
      //expect(instance).to.be.a(SalesforceMarketingCloud.ApiError);
    });
